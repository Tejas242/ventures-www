          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>Engineering College Campus, Innovation Hub, Room 112</span>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:team@ventures.edu" className="hover:text-emerald-400 transition-colors duration-300">
                  team@ventures.edu
                </a>
              </li>
              <li className="flex items-center">
